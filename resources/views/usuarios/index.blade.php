...
<head>
    ...
    <title>Tomodachi CRM - Usuários</title>
        ...
        <div class="main-content">
            ...
            <div class="header">
                ...
                <div class="header-right">
                    ...
                    <a href="{{ route('usuarios.create') }}" class="add-button">
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card">
                    <h3>{{ $usuarios->where('ativo', true)->count() }}</h3>
                    <p>Usuários Ativos</p>
                </div>
                <div class="stat-card">
                    <h3>{{ $usuarios->where('perm_usuarios', true)->count() }}</h3>
                    <p>Administradores</p>
                </div>
            </div>
            ...
            <div class="content-section">
                ...
                <p>Gerencie a equipe e configure permissões de acesso</p>
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="user-phone">{{ $usuario->telefone }}</div>
                                    </td>
                                    <td>{{ $usuario->cargo }}</td>
                                    <td>
                                        <div class="permissions">
                                            @if($usuario->perm_clientes)
                                                <span class="permission-badge active">Clientes</span>
                                            @endif
                                            @if($usuario->perm_cores)
                                                <span class="permission-badge active">Cores</span>
                                            @endif
                                            ...
                                            @endif
                                            @if($usuario->perm_usuarios)
                                                <span class="permission-badge active">Usuários</span>
                                            @endif
                                        </div>
                                    </td>
                                    <td>
                                        <span style="color: {{ $usuario->ativo ? '#059669' : '#dc2626' }}; font-weight: 500;">
                                            {{ $usuario->ativo ? 'Ativo' : 'Inativo' }}
                                        </span>
                                    </td>
                                    <td>
                                        <div class="actions">
                                            <button class="action-btn edit" onclick="editUsuario({{ $usuario->id }})">
                                                <i class="fas fa-edit"></i>
                                            </button>
                                            <button class="action-btn delete" onclick="deleteUsuario({{ $usuario->id }})">
