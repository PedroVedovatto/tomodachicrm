...
<head>
    ...
    <title>Tomodachi CRM - Clientes</title>
    ...
    <div class="dashboard">
        ...
        <div class="main-content">
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card">
                    <h3>{{ $clientes->where('ativo', true)->count() }}</h3>
                    <p>Clientes Ativos</p>
                </div>
                <div class="stat-card">
                    <h3>{{ $clientes->where('created_at', '>=', now()->subMonth())->count() }}</h3>
                    <p>Novos este Mês</p>
                </div>
            </div>
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ Str::limit($cliente->endereco, 30) }}</td>
                                    <td>{{ $cliente->created_at->format('d/m/Y') }}</td>
                                    <td>
                                        <div class="actions">
                                            <button class="action-btn edit" onclick="editCliente({{ $cliente->id }})">
                                                <i class="fas fa-edit"></i>
                                            </button>
                                            <button class="action-btn delete" onclick="deleteCliente({{ $cliente->id }})">
